...
def build_patch_database(
    ...
    patch_cache = build_or_load_patch_cache(single_cfg.map_path, single_cfg)
    ...
    encoder = CoarsePatchEncoder(descriptor_dim=single_cfg.descriptor_dim, init_seed=single_cfg.model_seed).to(device)
    ...
    if output_path is not None:
        ...
        output = Path(single_cfg.cache_dir) / f"descriptor_bank_{entry['sequence_name']}.npz"
    ...
    result["sequence_name"] = entry["sequence_name"]
