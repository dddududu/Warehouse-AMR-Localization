...
class FineLocalizationConfig:
    ...
    tracker_pose_init_candidate_deep_prob_min: float | None = None
    tracker_pose_init_required_margin_when_deep_low: float = 0.0
    tracker_pose_init_candidate_deep_prob_high: float | None = None
    tracker_pose_init_required_margin_when_deep_high: float = 0.0
    tracker_pose_init_release_streak_min: int | None = None
    tracker_pose_init_release_candidate_deep_prob_min: float | None = None
    tracker_pose_init_release_required_margin: float = 0.0
    tracker_pose_init_sticky_patch_streak_min: int | None = None
    tracker_pose_init_sticky_prev_deep_prob_max: float | None = None
    tracker_pose_init_sticky_candidate_deep_prob_min: float | None = None
    tracker_pose_init_sticky_required_margin: float = 0.0
    tracker_pose_init_patch_stable_min_frames: int | None = None
    tracker_pose_init_disable_hysteresis_streak: int | None = None
    tracker_pose_init_disable_hysteresis_min_deep_prob: float | None = None
    tracker_pose_init_disable_after_override_frames: int | None = None
    tracker_pose_init_disable_after_override_min_deep_prob: float | None = None
    ...
    apply_online_patch_hysteresis_during_tracking: bool = False
    ...
    online_patch_switch_force_min_score_advantage: float = 0.0
    online_patch_challenger_min_deep_prob: float | None = None
    online_patch_challenger_min_support: float | None = None
    online_patch_challenger_min_streak: int | None = None
    online_patch_tracker_release_min_streak: int | None = None
    online_patch_tracker_release_prev_deep_prob_max: float | None = None
    online_patch_tracker_release_prev_support_max: float | None = None
    online_patch_dynamic_margin_min_scale: float = 1.0
    online_patch_dynamic_margin_max_scale: float = 1.0
    online_patch_dynamic_margin_tracker_factor: float = 1.0
